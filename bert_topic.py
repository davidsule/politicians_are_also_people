"""
Initially Imported from https://github.itu.dk/robv/intro-nlp2023/blob/main/assignments/week6/bert/bert-topic.py
...
Example usage:
python bert_topic.py CrossRE/crossre_data/music-train.json CrossRE/crossre_data/music-dev.json
"""
